...
["bdogpee"] = {
        ...
        AnimationOptions = {
            ...
            PtfxNoProp = true,
            PtfxPlacement = { -0.15, -0.35, 0.0, 0.0, 90.0, 180.0, 1.0 },
            PtfxInfo = "Maintenir G pour faire pipi", -- 👈 CHANGE JUSTE CETTE LIGNE
            PtfxWait = 3000,
            PtfxCanHold = true,
        }
    },
    ["bdogpee2"] = {
        ...
        AnimationOptions = {
            ...
            PtfxName = "ent_anim_dog_peeing",
            PtfxNoProp = true,
            PtfxPlacement = { 0.15, -0.35, 0.0, 0.0, 90.0, 0.0, 1.0 },
            PtfxInfo = "Maintenir G pour faire pipi", -- 👈 CHANGE JUSTE CETTE LIGNE
            PtfxWait = 3000,
            PtfxCanHold = true,
        }
