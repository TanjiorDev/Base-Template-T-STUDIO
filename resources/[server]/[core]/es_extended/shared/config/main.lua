...
Config.StartingAccountMoney = { bank = 12000 }
...
Config.DefaultJob2Duty = false -- A players default duty status for their secondary job when changing jobs (Nexora Developments)
