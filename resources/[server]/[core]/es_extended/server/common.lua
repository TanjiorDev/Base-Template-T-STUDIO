...
MySQL.ready(function()
    ...
    print(("[^2T STUDIO Developments^0] Base Template T STUDIO ^4v%s^0 initialisée avec ^4Jobs2^0 intégré !"):format(GetResourceMetadata(GetCurrentResourceName(), "version", 0)))
