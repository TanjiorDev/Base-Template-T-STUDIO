...
RegisterNetEvent('esx_multicharacter:CharacterChosen', function(charid, isNew)
	if type(charid) == 'number' and charid % 1 == 0 and charid >= 1 and charid <= 99 and type(isNew) == 'boolean' then
		if isNew then
...
RegisterNetEvent('esx_multicharacter:DeleteCharacter', function(charid)
	if Config.CanDelete and type(charid) == 'number' and charid % 1 == 0 and charid >= 1 and charid <= 99 then
