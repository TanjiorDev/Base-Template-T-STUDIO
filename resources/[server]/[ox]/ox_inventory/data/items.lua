...
["blueprint_advancedlockpick"] = {
    ...
    stack = false,
    close = true,
    description = 'Une pioche solide pour casser de la roche.   '
    },
    ...
    ['stone'] = {
        ...
        stack = true,
        close = true,
        description = 'Un morceau de roche brute extrait de la mine.'
    },
    ...
    ['iron_ingot'] = {
        ...
        stack = true,
        close = true,
        description = 'Un lingot raffiné prêt à être revendu.'
    }
}